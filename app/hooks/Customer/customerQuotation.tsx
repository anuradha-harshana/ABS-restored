// hooks/generateQuotationPdf.ts
import jsPDF from "jspdf";

const generateQuotationPdf = async (quotationData: any) => {
  ...
  doc.setFontSize(18);
  doc.text("CUSTOMER QUOTATION", 96, 25, { align: "center" });
  ...
  doc.save(`Quotation_${quotationData.id}.pdf`);
};
