...
const CustomerDetailsView = ({ customer }: CustomerDetailsViewProps) => {
  ...
  const qrCodeUrl = customer.chasisNumber && customer.engineNumber
    ? `https://abs-sigma.vercel.app/portal/${customer.chasisNumber}/${customer.engineNumber}`
    : 'https://abs-sigma.vercel.app/portal/{chassis}/{engine}'
